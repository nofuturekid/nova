...
| **v0.1.36** | **release** | Stable promotion of the 0.1.36 cycle — store-flavor true-zero-GitHub privacy fix (MainViewModel + SettingsViewModel + Overview banner + UpdateDialog all guarded); pre-work for the F-Droid metadata MR **(Latest)** |
